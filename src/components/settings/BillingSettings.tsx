...
import { CreditCard, Loader2, Calendar, FileText, RefreshCw } from 'lucide-react';
        ...
        {isLoadingSub ? (
          ...
          <div className="flex items-center justify-between bg-muted/50 p-4 rounded-lg border">
            <div>
              ...
              <p className="text-sm text-muted-foreground">$399 per month</p>
            </div>
          ...
          <div className="flex items-center justify-between bg-muted/50 p-4 rounded-lg border">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Subscribe to access premium features</p>
            </div>
          ...
          <>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center justify-between p-4 rounded-lg border">
                ...
                <Button variant="outline" size="sm" onClick={handleManageSubscription}>Edit</Button>
              </div>
            </div>
